...
class TutorsControllerTest < ActionController::TestCase
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post :create, tutor: { bio: @tutor.bio, format: @tutor.format, name: @tutor.name, price: @tutor.price, university: @tutor.university }
    end
  ...
  test "should update tutor" do
    patch :update, id: @tutor, tutor: { bio: @tutor.bio, format: @tutor.format, name: @tutor.name, price: @tutor.price, university: @tutor.university }
    assert_redirected_to tutor_path(assigns(:tutor))
  end
